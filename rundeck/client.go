...
// Parameters:
// ID - job ID
func (client BaseClient) JobExecutionDeleteMethod(ctx context.Context, ID string) (result JobExecutionDelete, err error) {
	if tracing.IsEnabled() {
...
func (client BaseClient) JobExecutionDeleteMethodPreparer(ctx context.Context, ID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: systemACLPolicyCreateRequest,
			Constraints: []validation.Constraint{{Target: "systemACLPolicyCreateRequest", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "systemACLPolicyCreateRequest.Contents", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: systemACLPolicyUpdateRequest,
			Constraints: []validation.Constraint{{Target: "systemACLPolicyUpdateRequest", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "systemACLPolicyUpdateRequest.Contents", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
